...
feature_image: "/images/building-a-service-mesh-with-istio/containers-microservices.jpg"
---
...
![](/images/building-a-service-mesh-with-istio/istio-service-mesh-overview.png)
...
![](/images/building-a-service-mesh-with-istio/istio-sidecar-pattern.png)
...
![](/images/building-a-service-mesh-with-istio/istio-control-plane-architecture.png)
...
![](/images/building-a-service-mesh-with-istio/istio-traffic-splitting-example.png)

*Source: [https://www.infoq.com/presentations/istio-service-mesh](https://www.infoq.com/presentations/istio-service-mesh)*

This could be made possible by pushing out the following policy change to the Envoy:

![](/images/building-a-service-mesh-with-istio/istio-traffic-routing-config.png)

*Source: [https://www.infoq.com/presentations/istio-service-mesh](https://www.infoq.com/presentations/istio-service-mesh)*

Envoy can also perform L7 routing for traffic steering based on HTTP headers as in the scenario below:

![](/images/building-a-service-mesh-with-istio/istio-l7-routing-example.png)
...
![](/images/building-a-service-mesh-with-istio/istio-mutual-tls-diagram.png)
