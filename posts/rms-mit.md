...
feature_image: "/images/rms-mit/rms-mit-cover.jpg"
---
...
The turn out at the meeting was pretty good, and there were some FSF merchandise right outside and I promptly bought a couple of books. Scanning the lounge for familiar faces, I quickly noticed [Niibe](http://www.linux.lk/~anu/gallery/rms_at_mit/dsc00423.jpg.html) walking over. Niibe came over to Sri Lanka and participated in a [Code Fest held at Virtusa](http://www.asia-oss.org/sep2005/materials/wg/CodeFest.pdf) as part of the sixth Asia Open Source Symposium. Niibe is well known for his efforts on the Linux kernel SuperH port.

One of the speakers was the venerable MIT professor [Gerald Jay Sussman](http://en.wikipedia.org/wiki/Gerald_Jay_Sussman), who invented the [Scheme programming language](http://www.schemers.org/) along with Guy Steele Jr, one of his former students. It was a very interesting talk titled “Software is never finished”.

[Eben Moglen](http://en.wikipedia.org/wiki/Eben_Moglen) followed soon afterwards, followed by [Richard Stallman](http://en.wikipedia.org/wiki/Richard_Stallman). RMS spoke about the evils of DRM and the new provisions introduced to counter it in GPLv3.

After the presentation, I managed to have a little chat with him in the lounge area, and when I mentioned the LKLUG he was quick to point out that a name change was in order. You can trust RMS not to miss that one. There was a long and heated LKLUG mail thread on this same issue way back in 2004. Thanks to lurker, I’ve managed to [dig it up](http://www.lug.lk/lurker/message/20040323.154440.6466f514.en.html).

Some photographs of the event [can be found here](http://www.linux.lk/~anu/gallery/rms_at_mit/dsc00393.jpg.html).
